...
const L = {
  fr:{
    ...
    score_total_lbl: 'Score SCA Total',
    score_sq_lbl: 'Specialty Quality',
    score_qs_lbl: 'Qualité Supérieure',
    score_eval_line: 'Évalué par <strong style="color:rgba(250,248,244,.7);">Impulso Coffee Lab</strong> · 21 Décembre 2025<br>Q-Grader Certifié SCA',
    score_arome: 'Arôme',
    score_saveur: 'Saveur',
    score_finale: 'Finale',
    score_acidite: 'Acidité',
    score_corps: 'Corps',
    score_balance: 'Balance',
    score_uniformite: 'Uniformité',
    score_tasse: 'Tasse Propre',
    score_douceur: 'Douceur',
    score_impression: 'Impression',
    score_humidite: 'Humidité',
    score_rendement: 'Rendement Z.14',
    score_varietal_lbl: 'Variétal',
    score_procede_lbl: 'Procédé',
    score_sq_badge: 'Specialty Quality',
    score_variety_line: 'Arabica · Lavé · Torréfaction Artisanale Moyenne',
    score_tag1: '☕ Miel Délicat',
    score_tag2: '🍫 Chocolat Fin',
    score_tag3: '✦ Texture Soyeuse',
    score_tag4: '🌿 Finale Nette &amp; Élégante',
    score_lbl_formats: 'Formats',
    score_lbl_sca: 'Score SCA',
    score_lbl_orig: 'Origine',
    score_lbl_proc: 'Procédé',
    score_lbl_alt: 'Altitude',
    score_lbl_var: 'Variété',
    score_lbl_torr: 'Torréfaction',
    score_val_orig: 'Ferme unique · Boyacá · Colombie',
    score_val_proc: 'Lavé — Pureté aromatique',
    score_val_torr: 'Moyenne Artisanale',
    score_bullet1: 'Micro-lot sélectionné à la main',
    score_bullet2: 'Traçabilité complète de la ferme à la tasse',
    score_bullet3: 'Seule ferme café vert de Boyacá',
    score_bullet4: 'Chaîne d\'approvisionnement verte',
    svg_arome: 'ARÔME 7.8',
    svg_saveur: 'SAVEUR 7.8',
    svg_finale: 'FINALE 8.0',
    svg_acidite: 'ACIDITÉ 7.8',
    svg_corps: 'CORPS 7.8',
    svg_balance: 'BALANCE 7.8',
  },
  en:{
    ...
    score_total_lbl: 'Total SCA Score',
    score_sq_lbl: 'Specialty Quality',
    score_qs_lbl: 'Superior Quality',
    score_eval_line: 'Evaluated by <strong style="color:rgba(250,248,244,.7);">Impulso Coffee Lab</strong> · December 21, 2025<br>SCA Certified Q-Grader',
    score_arome: 'Aroma',
    score_saveur: 'Flavour',
    score_finale: 'Aftertaste',
    score_acidite: 'Acidity',
    score_corps: 'Body',
    score_balance: 'Balance',
    score_uniformite: 'Uniformity',
    score_tasse: 'Clean Cup',
    score_douceur: 'Sweetness',
    score_impression: 'Overall',
    score_humidite: 'Moisture',
    score_rendement: 'Yield Z.14',
    score_varietal_lbl: 'Varietal',
    score_procede_lbl: 'Process',
    score_sq_badge: 'Specialty Quality',
    score_variety_line: 'Arabica · Washed · Medium Artisan Roast',
    score_tag1: '☕ Delicate Honey',
    score_tag2: '🍫 Fine Chocolate',
    score_tag3: '✦ Silky Texture',
    score_tag4: '🌿 Clean &amp; Elegant Finish',
    score_lbl_formats: 'Formats',
    score_lbl_sca: 'SCA Score',
    score_lbl_orig: 'Origin',
    score_lbl_proc: 'Process',
    score_lbl_alt: 'Altitude',
    score_lbl_var: 'Variety',
    score_lbl_torr: 'Roast',
    score_val_orig: 'Single farm · Boyacá · Colombia',
    score_val_proc: 'Washed — Aromatic purity',
    score_val_torr: 'Medium Artisan',
    score_bullet1: 'Hand-selected micro-lot',
    score_bullet2: 'Full traceability from farm to cup',
    score_bullet3: 'Only green coffee farm in Boyacá',
    score_bullet4: 'Green supply chain',
    svg_arome: 'AROMA 7.8',
    svg_saveur: 'FLAVOUR 7.8',
    svg_finale: 'AFTERTASTE 8.0',
    svg_acidite: 'ACIDITY 7.8',
    svg_corps: 'BODY 7.8',
    svg_balance: 'BALANCE 7.8',
  },
  es:{
    ...
    score_total_lbl: 'Puntaje SCA Total',
    score_sq_lbl: 'Specialty Quality',
    score_qs_lbl: 'Calidad Superior',
    score_eval_line: 'Evaluado por <strong style="color:rgba(250,248,244,.7);">Impulso Coffee Lab</strong> · 21 de Diciembre 2025<br>Q-Grader Certificado SCA',
    score_arome: 'Aroma',
    score_saveur: 'Sabor',
    score_finale: 'Final',
    score_acidite: 'Acidez',
    score_corps: 'Cuerpo',
    score_balance: 'Balance',
    score_uniformite: 'Uniformidad',
    score_tasse: 'Taza Limpia',
    score_douceur: 'Dulzura',
    score_impression: 'Impresión',
    score_humidite: 'Humedad',
    score_rendement: 'Rendimiento Z.14',
    score_varietal_lbl: 'Varietal',
    score_procede_lbl: 'Proceso',
    score_sq_badge: 'Specialty Quality',
    score_variety_line: 'Arabica · Lavado · Tueste Medio Artesanal',
    score_tag1: '☕ Miel Delicada',
    score_tag2: '🍫 Chocolate Fino',
    score_tag3: '✦ Textura Sedosa',
    score_tag4: '🌿 Final Limpio &amp; Elegante',
    score_lbl_formats: 'Formatos',
    score_lbl_sca: 'Puntaje SCA',
    score_lbl_orig: 'Origen',
    score_lbl_proc: 'Proceso',
    score_lbl_alt: 'Altitud',
    score_lbl_var: 'Variedad',
    score_lbl_torr: 'Tueste',
    score_val_orig: 'Finca única · Boyacá · Colombia',
    score_val_proc: 'Lavado — Pureza aromática',
    score_val_torr: 'Medio Artesanal',
    score_bullet1: 'Micro-lote seleccionado a mano',
    score_bullet2: 'Trazabilidad completa de la finca a la taza',
    score_bullet3: 'Única finca café verde de Boyacá',
    score_bullet4: 'Cadena de suministro verde',
    svg_arome: 'AROMA 7.8',
    svg_saveur: 'SABOR 7.8',
    svg_finale: 'FINAL 8.0',
    svg_acidite: 'ACIDEZ 7.8',
    svg_corps: 'CUERPO 7.8',
    svg_balance: 'BALANCE 7.8',
  }
};
...
document.querySelectorAll('[data-i18n]').forEach(el => {
  ...
  // Score section localization
  const sset = (id, v) => { const e = _$(id); if (e && v !== undefined) { if (v.includes('<') || v.includes('&')) e.innerHTML = v; else e.textContent = v; } };
  sset('score-total-lbl', t.score_total_lbl);
  sset('score-sq-lbl', t.score_sq_lbl);
  sset('score-qs-lbl', t.score_qs_lbl);
  sset('score-eval-line', t.score_eval_line);
  sset('score-arome', t.score_arome);
  sset('score-saveur', t.score_saveur);
  sset('score-finale', t.score_finale);
  sset('score-acidite', t.score_acidite);
  sset('score-corps', t.score_corps);
  sset('score-balance', t.score_balance);
  sset('score-uniformite', t.score_uniformite);
  sset('score-tasse', t.score_tasse);
  sset('score-douceur', t.score_douceur);
  sset('score-impression', t.score_impression);
  sset('score-humidite', t.score_humidite);
  sset('score-rendement', t.score_rendement);
  sset('score-varietal-lbl', t.score_varietal_lbl);
  sset('score-procede-lbl', t.score_procede_lbl);
  sset('score-sq-badge', t.score_sq_badge);
  sset('score-variety-line', t.score_variety_line);
  sset('score-tag1', t.score_tag1);
  sset('score-tag2', t.score_tag2);
  sset('score-tag3', t.score_tag3);
  sset('score-tag4', t.score_tag4);
  sset('score-lbl-formats', t.score_lbl_formats);
  sset('score-lbl-sca', t.score_lbl_sca);
  sset('score-lbl-orig', t.score_lbl_orig);
  sset('score-lbl-proc', t.score_lbl_proc);
  sset('score-lbl-alt', t.score_lbl_alt);
  sset('score-lbl-var', t.score_lbl_var);
  sset('score-lbl-torr', t.score_lbl_torr);
  sset('score-val-orig', t.score_val_orig);
  sset('score-val-proc', t.score_val_proc);
  sset('score-val-torr', t.score_val_torr);
  sset('score-bullet-1', t.score_bullet1);
  sset('score-bullet-2', t.score_bullet2);
  sset('score-bullet-3', t.score_bullet3);
  sset('score-bullet-4', t.score_bullet4);
  // SVG radar chart labels
  sset('svg-arome', t.svg_arome);
  sset('svg-saveur', t.svg_saveur);
  sset('svg-finale', t.svg_finale);
  sset('svg-acidite', t.svg_acidite);
  sset('svg-corps', t.svg_corps);
  sset('svg-balance', t.svg_balance);
