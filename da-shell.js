...
#site-bars{position:fixed;top:0;left:0;right:0;z-index:1003;}
#promo-bar{height:var(--promo-h,34px);background:#0a0a0a;color:#fff;text-align:center;font-family:'Lato',sans-serif;font-size:11px;letter-spacing:1.4px;text-transform:uppercase;padding:0 16px;line-height:var(--promo-h,34px);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
@media(max-width:980px){#site-bars{position:sticky;}#promo-bar{height:auto;line-height:1.4;padding:8px 12px;white-space:normal;}}
...
const L = {
  fr:{
    ...
    hh1tag:"Sourcing d'Exception", hh1title:'Cafés de Spécialité<br>Durables & Traçables', hh1desc:"Sélectionnés parmi les meilleures fermes certifiées — à l'image de notre ferme exclusive de Boyacá, seule Green Coffee Farm d'un département de 1,3 million d'habitants.",
  ...
  en:{
    ...
    hh1tag:'Exceptional Sourcing', hh1title:'Sustainable Specialty<br>Coffee, Fully Traceable', hh1desc:'Sourced from the finest certified farms — like our exclusive Boyacá farm, the only Green Coffee Farm in a department of 1.3 million people.',
  ...
  es:{
    ...
    hh1tag:'Origen Excepcional', hh1title:'Café de Especialidad<br>Sostenible & Trazable', hh1desc:'Seleccionado en las mejores fincas certificadas — como nuestra finca exclusiva de Boyacá, única Green Coffee Farm en un departamento de 1,3 millones de habitantes.',
